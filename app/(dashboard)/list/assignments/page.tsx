...
import { formatDateToMonthDayYear, ITEM_PER_PAGE } from "@/lib/settings";
...
const AssignmentListPage = async ({
  ...
  const renderRow = (item: AssignmentList) => (
    ...
    >
      ...
      <td className="hidden md:table-cell">
        {formatDateToMonthDayYear(item.startDate)}
      </td>
      <td className="hidden md:table-cell">
        {formatDateToMonthDayYear(item.dueDate)}
      </td>
      <td>
